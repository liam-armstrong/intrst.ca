...
app.controller("cellController", ["$scope", function($scope) {
  $scope.companies = [
      //Fido
      { imgsrc: "assets/images/fido.png", name1: "Fido", name2: "", plan: "3 GB Data, Talk and Text Plan",
        ...
        //Bell
      { imgsrc: "assets/images/bell.png", name1: "Bell", name2: "", plan: "Initial Device - Unlimited anytime nationwide minutes + 2 GB (Share Plan)",
          ...
          //Rogers
      { imgsrc: "assets/images/rogers.png", name1: "Rogers", name2: "", plan: "1 GB + 1 GB Share Everything Plan",
          ...
          //Koodo
      { imgsrc: "assets/images/koodo.png", name1: "Koodo", name2: "", plan: "1 GB Data + 1 GB Shock-Free Data",
          minutes: "Unlimited in Canada", texts: "Unlimited",
          data: 2, price: 55, bonuses: "call display, voicemail, call waiting, conference calling",
          link: "https://www.koodomobile.com/rate-plans"},
          //Freedom
      { imgsrc: "assets/images/freedom.png", name1: "Freedom", name2: "(Formerly Wind)", plan: "Smartphone Plan 1",
          ...
          //Chatr
      { imgsrc: "assets/images/chatr.png", name1: "Chatr", name2: "(Formerly Mobilicity)", plan: "$45 per month Talk, Text, Data Plan",
          ...
          //Telus
      { imgsrc: "assets/images/telus.png", name1: "Telus", name2: "", plan: "Elite 67",
          ...
          //Virgin
      { imgsrc: "assets/images/virgin.png", name1: "Virgin Mobile", name2: "", plan: "Unlimited minutes + 2 GB",
          ...
          //T-mobile
      { imgsrc: "assets/images/tmobile.png", name1: "T-Mobile", name2: "", plan: "Simply Prepaid Plan",
          minutes: "Unlimited in Canada, USA and Mexico", texts: "Unlimited",
          data: 3, price: 45, bonuses: "freedom to either buy new device or keep own, stream music (music unlimited)",
          link: "https://prepaid-phones.t-mobile.com/prepaid-plans-individual"}
  ];
}]);
