...
app.controller("foodController", ["$scope", function($scope) {
    $scope.companies = [
      { imgsrc: "assets/images/compare/ubereats.jpg", name: "UberEats", access: "Mobile App and Website", charge: "$5.00", drinks: "Bubble tea, Juice and smoothies", food: "#NAME?", range: "Toronto, Mississauga, Edmonton, Ottawa", link: "https://www.ubereats.com", },
      { imgsrc: "assets/images/compare/justeat.png", name: "JustEat", access: "Mobile App and Website", charge: "Typically $3.00",  drinks: "N/A", food: "#NAME?", range: "Most Major Cities in Canada", link: "https://www.just-eat.ca", },
      { imgsrc: "assets/images/compare/foodora.jpg", name: "Foodora", access: "Mobile App and Website", charge: "$5.50 plus $2 per kilometer from pick-up point to destination",  drinks: "Bubble tea, Juices and Smoothies", food: "#NAME?", range: "Dupont to Lake Ontario, Keele to the DVP", link: "https://www.foodora.ca/", },
      { imgsrc: "assets/images/compare/sohungry.png", name: "So Hungry", access: "Website Only", charge: "$0.00",  drinks: "N/A", food: "#NAME?", range: "Toronto", link: "http://www.sohungry.com/order-food.html", },
      { imgsrc: "assets/images/compare/feastbank.png", name: "Feast Bank", access: "Mobile App and Website", charge: "N/A",  drinks: "N/A", food: "#NAME?", range: "Toronto", link: "https://www.eatfeast.com/guiding-principles", },
      { imgsrc: "assets/images/compare/doordash.png", name: "Door Dash", access: "Mobile app and Website", charge: "Between $3.99 and $4.99",  drinks: "Smoothies", food: "#NAME?", range: "Toronto, Vancouver, Etobicoke", link: "https://www.doordash.com/" }
    ];
}]);

app.controller("TvController", ["$scope", function($scope) {
    $scope.companies = [
      { name: "Netflix", cost: "$9.99/month", accessibility: "PC and Mac, Apple TV, PS4 Android, Windows Phones, iOS, internet-enabled TVs",
      ...
      { name: "Amazon Prime Instant Video", cost: "$79/year", accessibility: "PC and Mac, the Kindle Fire HD, iPad, Xbox One, PS4, internet-enabled TVs and Blu-ray players, Sony's Home Cinema system, Sony's Network Media Player",  features: "Comes with Amazon Prime membership 30 day free trial Available in different countries Own original series Content is limited compared to other platforms Entire library is available for offline viewing"  },
      { name: "Crave TV", cost: "$7.99/month $6/month with Bell TV", accessibility: "They have an app, and are available one iOS, Android, Xbox One and Apple TV",  features: "They do not have any movies, just hundreds of TV shows and a few documentaries They have exclusive content as the service features HBO&rsquo;s back catalogue of content as well as new Showtime content, for no additional fee Produces their own shows such as Letter Kenney Allows a one month free trial"  },
      { name: "Shomi", cost: "$8.99/month", accessibility: "They have an app, cable connection through Rogers and Shaw, are also available on Apple TV and through Chromecast",  features: "They distinguish themselves with &ldquo;human curation,&rdquo; whereby a content team of between 10 and 15 people crafts collections to suggest to users, rather than relying solely on algorithms They have limited movie selection However, their content is focused on new and recent TV shows rather than older ones Shomi has an exclusive deal to air Amazon's original content, starting with acclaimed comedy Transparent. They are also the only streaming service in Canada with shows such as American Horror Story"  },
      { name: "Sling TV", cost: "$20/month", accessibility: "It's available on iOS,Android, Amazon Fire TV and Amazon Fire TV Stick, Google's Nexus Player, Xbox One and Roku TV. The service will also work on select LG and Samsung smart TVs, and on Macs and PCs via a website portal",  features: "Thy provide 13 cable channels - ESPN, ESPN2, TNT, TBS, HGTV, DIY Network, Food Network, Travel Channel, CNN, Cartoon Network, ABC Family, Disney Channel and AMC They also have three add-on packages are available for $5 apiece per month:Kids Extra, with Disney Jr, Disney XD, Boomerang, Duck TV, and Baby TV. Sports Extra, which includes the SEC Network, ESPNEWS, ESPNU, Universal Sports, Univision Deportes, beIN Sports, ESPN Buzzer Beater, ESPN Bases Loaded and ESPN Goal Line. News and info extra, which has HLN, Cooking Channel and Bloomberg TV"  },
      { name: "Crunchyroll", cost: "$6.95 to watch any content in HD", accessibility: "iOS, Android, Windows Phone, PS4, Wii U, Xbox One, PlayStation 3, PlayStation Vita, Xbox 360, Chromecast, Apple TV, Roku, Google TV and Samsung and Panasonic's line of Smart TVs",  features: "This network is exclusively for an audience that watches anime, manga or any East-Asian cinema All their content is in standard definition, but you can pay a small fee to watch in HD"  }
    ];
}]);
