...
app.controller("chequingController", ["$scope", function($scope) {
  $scope.banks = [
      //TD
      { imgsrc: "assets/images/compare/TD.png", name1: "Youth Savings", name2: "Account", requirement: "12+",
      ...
      //RBC
      { imgsrc: "assets/images/compare/RBC.png", name1: "Leo's Young", name2: "Savers Account", requirement: "13+",
      ...
      //CIBC
      { imgsrc: "assets/images/compare/CIBC.png", name1: "Advantage", name2: "for Youth", requirement: "18+",
      ...
      //Scotiabank
      { imgsrc: "assets/images/compare/Scotiabank.png", name1: "Getting There", name2: "", requirement: "18+",
          bankTrans: "None", nonBankFees: "$1.50 per",
          nonBankTrans: "transaction", numATMS: "37",
          link: "http://www.scotiabank.com/ca/en/0,,60,00.html"},
      //National Bank
      { imgsrc: "assets/images/compare/NationalBank.png", name1: "Strategist Account", name2: "", requirement: "7-12",
      ...
      //PC Financial
      { imgsrc: "assets/images/compare/PCFinancial.png", name1: "Interest Plus", name2: "Savings Account", requirement: "18+",
      ...
      //Tangerine
      { imgsrc: "assets/images/compare/Tangerine.png", name1: "Children's", name2: "Savings Account", requirement: "16+",
      ...
      //ATB
      { imgsrc: "assets/images/compare/ATB.png", name1: "Generation Account", requirement: "University Students",
          bankTrans: "Unlimited", nonBankFees: "$1.50 per",
